      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 drop-shadow-lg">
              ...
              <span className="text-cyan-400">consulta desde $499</span>
            </h1>
            ...
            <div className="inline-flex items-center gap-2 bg-amber-500/25 border border-amber-400/50 text-amber-300 text-sm font-semibold px-4 py-2 rounded-full mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
              <a
                ...
                className="bg-green-500 hover:bg-green-600 text-white text-lg font-semibold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all inline-flex items-center gap-2"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
              ...
              <a
                ...
                className="text-white hover:text-cyan-300 font-semibold text-lg py-4 inline-flex items-center gap-2 transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-16">
          {features.map((f) => (
            ...
            >
              <div className="w-10 h-10 bg-cyan-400/30 rounded-lg flex items-center justify-center text-cyan-300 mb-3">
                {f.icon}
              </div>
