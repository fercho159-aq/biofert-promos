        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 drop-shadow-lg">
              Hacemos tu sueño{" "}
              <span className="text-accent-300">una realidad</span>
            </h1>

            <p className="text-lg sm:text-xl text-white/90 max-w-xl mb-4 leading-relaxed">
              Regalamos un ángel a tu vida. Somos una clínica especializada en
              reproducción asistida con diagnóstico y tratamiento de
              infertilidad para hombres y mujeres.
            </p>

            <p className="text-base text-brand-200 max-w-xl mb-8 leading-relaxed">
