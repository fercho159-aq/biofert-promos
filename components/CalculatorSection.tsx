        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-lg border border-brand-100 p-6 sm:p-8 min-h-[400px] flex flex-col">
              ...
              {/* Step 3: Result */}
              {step === 3 && (
                <div className="flex-1 text-center space-y-6 flex flex-col items-center justify-center">
                  <div className="w-20 h-20 bg-accent-400/10 rounded-full flex items-center justify-center">
                  ...
                  <div className="w-full bg-brand-50 border border-brand-100 rounded-xl p-5 text-left">
                    ...
                    <div className="bg-white rounded-lg p-4 mb-3">
                      <div className="font-bold text-brand-800">
                        {age === "Más de 40" || conditions.includes("Endometriosis")
                          ? "Fertilización In Vitro (FIV)"
                          : conditions.includes("Ninguna") && losses === "No"
                          ? "Consulta de fertilidad + estudios"
                          : "Fertilización In Vitro (FIV)"}
                      </div>
                      <div className="flex items-baseline gap-2 mt-1">
                        ...
                        {(age === "Más de 40" || !conditions.includes("Ninguna") || losses === "Sí") && (
                    ...
                    <p className="text-xs text-gray-500">
                      {conditions.includes("Ninguna") && losses === "No"
                        ? "El primer paso es una valoración completa con seminograma y estudio endovaginal incluidos."
                        : "Tu caso requiere una valoración especializada. Agenda tu consulta de $499 para recibir un diagnóstico completo y plan de tratamiento."}
                    </p>
                  </div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-accent-400 hover:bg-accent-500 text-white text-lg font-semibold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all"
                  >
