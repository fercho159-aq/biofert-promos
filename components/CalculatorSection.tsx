              ...
              {step === 3 && (
                <div className="flex-1 text-center space-y-6 flex flex-col items-center justify-center">
                  ...
                  <p className="text-gray-500 leading-relaxed max-w-sm">
                    Nuestros especialistas pueden brindarte un diagnóstico
                    personalizado. Envía tus datos por WhatsApp.
                  </p>

                  {/* Summary */}
                  <div className="w-full bg-brand-50 rounded-xl p-5 text-left space-y-3">
